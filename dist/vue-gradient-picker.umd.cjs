...
(function(global2, factory) {
  typeof exports === "object" && typeof module !== "undefined" ? factory(exports, require("vue")) : typeof define === "function" && define.amd ? define(["exports", "vue"], factory) : (global2 = typeof globalThis !== "undefined" ? globalThis : global2 || self, factory(global2["vue-gradient-picker"] = {}, global2.Vue));
  ...
  const _hoisted_3$5 = /* @__PURE__ */ vue.createElementVNode("div", { class: "vc-alpha-picker" }, null, -1);
  const _hoisted_4$4 = [
    _hoisted_3$5
  ];
  function render$4(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    return vue.openBlock(), vue.createElementBlock("div", _hoisted_1$5, [
      ...
      vue.createElementVNode("div", {
        ...
        style: vue.normalizeStyle({ background: $options.gradientColor })
      }, null, 4),
      vue.createElementVNode("div", {
  ...
  function render$3(_ctx, _cache, $props, $setup, $data, $options) {
    return vue.openBlock(), vue.createElementBlock("div", _hoisted_1$4, [
      ...
      vue.createElementVNode("span", {
        ...
        id: $options.labelId
      }, vue.toDisplayString($options.labelSpanText), 9, _hoisted_3$4),
      vue.createElementVNode("span", _hoisted_4$3, vue.toDisplayString($props.desc), 1)
    ]);
  }
  ...
  const _hoisted_1$3 = /* @__PURE__ */ vue.createElementVNode("div", { class: "vc-saturation--white" }, null, -1);
  const _hoisted_2$3 = /* @__PURE__ */ vue.createElementVNode("div", { class: "vc-saturation--black" }, null, -1);
  const _hoisted_3$3 = /* @__PURE__ */ vue.createElementVNode("div", { class: "vc-saturation-circle" }, null, -1);
  const _hoisted_4$2 = [
    _hoisted_3$3
  ];
  function render$2(_ctx, _cache, $props, $setup, $data, $options) {
    return vue.openBlock(), vue.createElementBlock("div", {
      class: "vc-saturation",
      style: vue.normalizeStyle({ background: $options.bgColor }),
      ref: "container",
      onMousedown: _cache[0] || (_cache[0] = (...args) => $options.handleMouseDown && $options.handleMouseDown(...args)),
      onTouchmove: _cache[1] || (_cache[1] = (...args) => $options.handleChange && $options.handleChange(...args)),
      onTouchstart: _cache[2] || (_cache[2] = (...args) => $options.handleChange && $options.handleChange(...args))
  ...
  const _hoisted_2$2 = /* @__PURE__ */ vue.createElementVNode("div", { class: "vc-hue-picker" }, null, -1);
  const _hoisted_3$2 = [
    _hoisted_2$2
  ];
  function render$1(_ctx, _cache, $props, $setup, $data, $options) {
    return vue.openBlock(), vue.createElementBlock("div", {
      class: vue.normalizeClass(["vc-hue", $options.directionClass])
    }, [
      vue.createElementVNode("div", {
  ...
  function render(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    const _component_checkboard = vue.resolveComponent("checkboard");
    const _component_ed_in = vue.resolveComponent("ed-in");
    return vue.openBlock(), vue.createElementBlock("div", {
      role: "application",
      ...
      vue.createElementVNode("div", _hoisted_2$1, [
        vue.createElementVNode("div", _hoisted_3$1, [
          ...
          !$props.disableAlpha ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_5$1, [
      ...
      !$props.disableFields ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_8$1, [
        vue.createCommentVNode(" rgba "),
        vue.createElementVNode("div", _hoisted_9$1, [
          vue.createVNode(_component_ed_in, {
            label: "hex",
            value: $options.hex,
      ...
      vue.createElementVNode("div", _hoisted_14, [
        (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList($props.presetColors, (c) => {
          return vue.openBlock(), vue.createElementBlock(vue.Fragment, null, [
            !_ctx.isTransparent(c) ? (vue.openBlock(), vue.createElementBlock("div", {
              key: `!${c}`,
              class: "vc-sketch-presets-color",
              "aria-label": "Color:" + c,
              style: vue.normalizeStyle({ background: c }),
              onClick: ($event) => $options.handlePreset(c)
            }, null, 12, _hoisted_15)) : (vue.openBlock(), vue.createElementBlock("div", {
              key: c,
              "aria-label": "Color:" + c,
              class: "vc-sketch-presets-color",
              onClick: ($event) => $options.handlePreset(c)
  ...
  const _hoisted_9 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ vue.createElementVNode("div", { class: "label" }, "Angle", -1));
  const _hoisted_10 = { class: "vue-gpickr-input-container" };
  const _hoisted_11 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ vue.createElementVNode("div", { class: "label" }, "Deg\xB0", -1));
      ...
      vue.createElementVNode("div", _hoisted_2, [
        vue.createElementVNode("div", _hoisted_3, [
          vue.createElementVNode("div", {
            ...
            style: vue.normalizeStyle(_ctx.previewStyle)
          }, null, 4)
        ]),
        vue.createElementVNode("div", _hoisted_4, [
          vue.createElementVNode("div", _hoisted_5, [
            vue.createElementVNode("div", {
              ...
              style: vue.normalizeStyle(_ctx.stopsPreviewStyle),
              onClick: _cache[1] || (_cache[1] = vue.withModifiers(($event) => _ctx.addStop($event), ["stop", "prevent"]))
            }, null, 4)
          ]),
          (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(_ctx.stops, (_, index) => {
            return vue.openBlock(), vue.createElementBlock("div", {
              key: index,
              class: vue.normalizeClass(["vue-gpickr-stop", { active: index == _ctx.currentStopIdx }]),
              style: vue.normalizeStyle(_ctx.stopStyle(index)),
              onMousedown: vue.withModifiers(($event) => _ctx.handleMouseDown(index), ["stop"]),
              onTouchstart: vue.withModifiers(($event) => _ctx.handleTouchstart(index), ["stop"])
            }, null, 46, _hoisted_6);
          }), 128))
        ], 512),
